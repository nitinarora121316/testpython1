...
if __name__ == "__main__":
    ...
    for row_num, row_data in enumerate(all_data, start=2):
        ...
        # result = "Pass" if page_title == "VWO - Application" else "Fail"
        result = "Pass" if page_url == "https://app.vwo.com/#/login1" else "Fail"
        
        # Write the result to the Excel sheet
        xlutils.writeData(sheetName, row_num, 3, result)
